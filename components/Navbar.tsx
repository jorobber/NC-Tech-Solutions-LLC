      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-6">
            {navLinks.map((link) => (
              <a
                ...
                className={`text-base font-medium ${textColor} ${textHover} transition-colors duration-200 relative group`}
              >
                {link.label}
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg border ${toggleBorder} text-sm font-semibold ${textColor} ${textHover} transition-all duration-200 hover:border-blue-500/30`}
            ...
            <a
              ...
              className="btn-primary text-base font-semibold px-5 py-2.5 rounded-lg text-white"
            >
              {t.nav.getQuote}
            </a>
          </div>
          ...
          <div className="flex lg:hidden items-center gap-2">
            <button
              onClick={toggleLanguage}
              className={`px-2.5 py-1.5 rounded-lg text-sm font-semibold ${textColor} border ${toggleBorder}`}
              aria-label="Toggle language"
            >
              {language === 'en' ? 'ES' : 'EN'}
            </button>
            ...
            <div className="px-4 py-6 mt-2 mx-4 rounded-xl glass-card space-y-1">
              ...
              <div className="pt-3 px-4">
                <a
                  href="#contact"
                  onClick={(e) => handleNavClick(e, '#contact')}
                  className="btn-primary block text-center text-base font-semibold px-5 py-3 rounded-lg text-white"
                >
                  {t.nav.getQuote}
                </a>
              </div>
